...
This project is split into two main 'versions':
    ...
    1. the multi-file version, consisting of 31 files, labelled 'polyphonic' in the .zip
    
    2. the single-file version, having only one file, labelled 'monophonic' in the .zip
