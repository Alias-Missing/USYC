    ...
    public static void PrintMenu_Main()
{
    ...
    System.out.println("7. Cartesian Menu");
    System.out.println("----CHEMISTRY----");
    System.out.println("8. Gram-to-Mol");
    System.out.println("9. Gram-to-Atom");
    System.out.println("10. Mol-to-Gram");
    System.out.println("11. Mol-to-Atom");
    System.out.println("12. Stoichiometry- Mol-to-Mol");
    System.out.println("13. Stoichiometry- Mol-to-Gram");
    System.out.println("14. Molar Mass Lookup");
    System.out.println("----BASIC----");
    System.out.println("15. Convert Fahrenheit to Celsius");
    System.out.println("16. Convert Celsius to Fahrenheit");
    System.out.println("17. Secret Menu");
    System.out.println("----PHYSICS----");
    System.out.println("18. Force, Mass, and Acceleration");
    System.out.println("19. Gas Laws");
